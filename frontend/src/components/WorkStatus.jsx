...
export default function WorkStatus() {
  ...
  const { weddingEvents, partyEvents, updateEventStatus, addEvent } = useWorkContext();
  ...
  const undeterminedCount = allEvents.filter(e => e.status === 'undetermined').length;
  ...
  const getStatusLabel = (status) => {
    switch(status) {
      ...
      case 'undetermined': return 'ยังไม่ได้กำหนด';
  ...
  const getStatusColor = (status) => {
    switch(status) {
      ...
      case 'undetermined': return 'status-undetermined';
      default: return '';
    }
  };
    ...
    <div className="ws-layout">
      ...
      <aside className="ws-sidebar">
        ...
        <nav className="nav-menu">
          ...
          <Link to="/workrecord/status" className="nav-item active">สถานะงาน</Link>
      ...
      <main className="ws-content">
        <header className="ws-header">
          ...
          <div className="header-right">
             <button type="button" className="create-work-btn" onClick={handleOpenModal}>
                ...
                <tr key={event.id}>
                  ...
                  <td className="col-status">
                    <div className="status-dropdown-wrapper">
                      ...
                      <span className="select-arrow"><IconChevronDown /></span>
                    </div>
                  </td>
        ...
        <div className="modal-overlay" onClick={handleCloseModal}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-form">
              ...
              <div className="form-group">
                ...
                <div className="select-wrapper">
                  ...
                  <span className="select-arrow-black"><IconChevronDown /></span>
                </div>
              </div>
            </div>
            ...
            <div className="modal-actions">
              ...
              <button className="btn-save" onClick={handleSaveWork}>สร้างงาน</button>
            </div>
          </div>
        </div>
      )}
